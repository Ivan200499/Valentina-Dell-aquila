...
function App() {
  ...
  return (
    <div className="bg-neutral-50 text-neutral-900">
      {/* Hero Section */}
      <section className="h-[100svh] relative overflow-hidden" data-aos="fade-up">
      ...
      <section className="py-16 sm:py-20 px-4 md:px-8 max-w-4xl mx-auto" data-aos="fade-up">
        ...
        <p className="text-base sm:text-lg leading-relaxed text-neutral-700 text-center">
          Sono Valentina Dell'Aquila, vengo da Taranto, Puglia, e ho iniziato il mio percorso nel mondo della moda nel 2023, anche se la passione per questo settore è sempre stata con me. Ho partecipato a concorsi provinciali e nazionali, dove ho ottenuto diversi riconoscimenti, tra cui la fascia di Miss Eleganza 2024 al concorso Mondo Sposa Italia, e la fascia di Miss Moda e Un Volto per Foto Modella.
